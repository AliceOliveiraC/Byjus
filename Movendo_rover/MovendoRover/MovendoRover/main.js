...
nasa_Mars_Image_Array = ["nasa_image_1.jpg" , "nasa_image_2.jpeg" , "nasa_image_3.jpg" , "nasa_image_4jpg"]
...
background_image = nasa_Mars_Image_Array[randomNumber];
...
{
	roverY = roverY - 10;
	console.log("quando tecla para cima for pressionada, x = " + roverX +" I y = "+roverY);
	uploadBackground();
	uploadrover();
}
}
