...
function my_keydown(e)
{
	...
	console.log(keyPressed);
		...
		{
			car1Y = car1Y - 10;
			console.log("Quando tecla para cima for pressionada, x = " + car1X + "i y = "+car1Y);
			uploadBackground();
			uploadcar1();
		...
		{
			car1Y = car1Y + 10;
			console.log("Quando tecla para baixo for pressionada, x = " + car1X + "i y = "+car1Y);
			uploadBackground();
			uploadcar1();
		...
		function car1_left()
		{
			...
			{
				car1Y = car1Y - 10;
				console.log("Quando tecla para esquerda for pressionada, x = " + car1X + "i y = "+car1Y);
				uploadBackground();
				uploadcar1();
		...
		function car1_right()
		{
			...
			{
				car1Y = car1Y + 10;
				console.log("Quando tecla para direita for pressionada, x = " + car1X + "i y = "+car1Y);
				uploadBackground();
				uploadcar1();
...
function car1_up(){
	...
	function car2_down(){
		...
		{
			car2Y = car2Y + 10;
			console.log("Quando tecla para baixo for pressionada, x = " + car2X + "i y = "+car2Y);
			uploadBackground();
			uploadcar2();
		}
		}
		...
		function car2_up(){
			...
			{
				car2Y = car2Y - 10;
				console.log("Quando tecla para cima for pressionada, x = " + car2X + "i y = "+car2Y);
				uploadBackground();
				uploadcar2();
			}
			}
	...
	function car2_left()
	{
		...
		{
			car2Y = car2Y - 10;
			console.log("Quando tecla para esquerda for pressionada, x = " + car2X + "i y = "+car2Y);
			uploadBackground();
			uploadcar2();	
		}
	}
	...
	function car2_right()
	{
		...
		{
			car2Y = car2Y + 10;
			console.log("Quando tecla para direita for pressionada, x = " + car2X + "i y = "+car2Y);
			uploadBackground();
			uploadcar2();		
		}
	}
